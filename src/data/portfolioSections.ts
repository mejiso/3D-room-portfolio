...
export const portfolioSections: PortfolioSection[] = [
  ...
  },
  {
    ...
    summary:
      '',
    bullets: [
      'I learned Blender just to 3D model this portfolio room, and it is based on my real room!',
      'All the music in this portfolio is original music produced and sung by me.',
      'I have been producing music since I was 13, starting with a placement for the Hmong girl group Cua Tshiab.',
      'Since then, I have produced 150+ digital projects and pitched 50+ tracks as a Producer for ATUNES.',
      'I was signed to a K-Pop publishing company my senior year of high school, so there is a chance I pitched to your favorite K-pop artists.',
      'I used to play the Launchpad Pro, the shiny MIDI controller that makes music lightshows on YouTube.',
      'My top 3 artists are Norah Jones, Laufey, and Bruno Major.',
      'I started college as pre-med, then switched to Computer Science the summer after freshman year.',
      'I fell in love with CS right away and have been building things ever since.',
