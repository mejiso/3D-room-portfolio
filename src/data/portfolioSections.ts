...
export const portfolioSections: PortfolioSection[] = [
  ...
  },
  {
    ...
    summary:
      '',
    bullets: [
      'I learned how to 3D model this room in Blender just for this portfolio, and it is actually an accurate representation of my real life room!',
      'The music playing in this portfolio are all originals produced/sang by me!',
      'I have been producing music since the age of 13! I landed my first placement with a Hmong Girl Group \'Cua Tshiab\' when I was 13, and I went on to produce over 150 digital projects and pitch over 50 tracks as a Producer for ATUNES.',
      ...
      'I used to play the Launchpad Pro, the shiny MIDI controller you see on youtube that plays lightshows with music!',
